...
import SendEmailUtility from "../routes/sendMail.js";
    ...
    if (user && (await user.matchPassword(password))) {
      try {
        const r = await axios.get("https://api.chatengine.io/users/me/", {
          headers: {
            "Project-ID": "0aa449fc-1ea7-4067-b27c-20dcf5344483",
            "User-Name": user.name,
    ...
    try {
      const r = await axios
        .post(
          ...
          { headers: { "PRIVATE-KEY": "d3130158-83bf-4185-9689-5566571b46c4" } }
        )
        .then((r) => {
          let data = { ...r.data };
          if (data.hasOwnProperty("secret")) {
